namespace UNOScoring.Constants
{
	public class ErrorConstants
	{
		...
		public const string ERROR_CAUSE_FEW_SCORE = "Scores cannot be less than 100";
		public const string ERROR_CAUSE_SAME_NAMES = "A player with this name has already been added";
		public const string ERROR_CAUSE_NO_WINNER = "At least one player must finish the round with 0 scores";
	}
}
